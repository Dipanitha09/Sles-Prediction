...
con_string = "mongodb+srv://ddipanitha0:<password>@website.8ezxmk6.mongodb.net/?retryWrites=true&w=majority"

client = pymongo.MongoClient(con_string)

db = client.get_database('Kaar')

user_collection = pymongo.collection.Collection(db, 'website')
